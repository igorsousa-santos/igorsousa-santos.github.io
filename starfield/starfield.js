...
function findWasmBinary() {
    return locateFile('starfield.wasm');
}
...
var ASM_CONSTS = {
  93008: () => { if (document.fullscreenElement) return 1; },  
 93054: () => { return Module.canvas.width; },  
 93086: () => { return parseInt(Module.canvas.style.width); },  
 93134: () => { document.exitFullscreen(); },  
 93161: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93234: () => { if (document.fullscreenElement) return 1; },  
 93280: () => { return Module.canvas.width; },  
 93312: () => { return screen.width; },  
 93337: () => { document.exitFullscreen(); },  
 93364: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93497: () => { return window.innerWidth; },  
 93523: () => { return window.innerHeight; },  
 93550: () => { if (document.fullscreenElement) return 1; },  
 93596: () => { return Module.canvas.width; },  
 93628: () => { return parseInt(Module.canvas.style.width); },  
 93676: () => { if (document.fullscreenElement) return 1; },  
 93722: () => { return Module.canvas.width; },  
 93754: () => { return screen.width; },  
 93779: () => { return window.innerWidth; },  
 93805: () => { return window.innerHeight; },  
 93832: () => { if (document.fullscreenElement) return 1; },  
 93878: () => { return Module.canvas.width; },  
 93910: () => { return screen.width; },  
 93935: () => { document.exitFullscreen(); },  
 93962: () => { if (document.fullscreenElement) return 1; },  
 94008: () => { return Module.canvas.width; },  
 94040: () => { return parseInt(Module.canvas.style.width); },  
 94088: () => { document.exitFullscreen(); },  
 94115: ($0) => { Module.canvas.style.opacity = $0; },  
 94153: () => { return screen.width; },  
 94178: () => { return screen.height; },  
 94204: () => { return window.screenX; },  
 94231: () => { return window.screenY; },  
 94258: () => { return window.devicePixelRatio; },  
 94294: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94347: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94398: () => { Module.canvas.style.cursor = 'none'; },  
 94435: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94691: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94742: () => { if (document.pointerLockElement) return 1; },  
 94789: () => { if (document.fullscreenElement) return 1; },  
 94835: () => { return window.innerWidth; },  
 94861: () => { return window.innerHeight; }
};
